                ...
                <div class="p-6">
                    <form action="{{ route('companies.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="cif" id="cif" value="{{ old('cif') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="A12345678">
