            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
                ...
                <div class="bg-white rounded-lg shadow p-4 md:p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-green-100 rounded-lg p-2 md:p-3">
                        ...
                        <div class="ml-3 md:ml-4">
                            <p class="text-xs md:text-sm font-medium text-gray-500">Días trabajados</p>
                            <p class="text-xl md:text-2xl font-bold text-gray-900">{{ $statistics['days_worked'] }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-4 md:p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-blue-100 rounded-lg p-2 md:p-3">
                            <svg class="w-6 h-6 md:w-8 md:h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </div>
                        <div class="ml-3 md:ml-4">
                            <p class="text-xs md:text-sm font-medium text-gray-500">Promedio/día</p>
                            <p class="text-xl md:text-2xl font-bold text-gray-900">{{ $statistics['avg_hours'] }}h {{ $statistics['avg_minutes'] }}m</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-4 md:p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-purple-100 rounded-lg p-2 md:p-3">
                        ...
                        <div class="ml-3 md:ml-4">
                            <p class="text-xs md:text-sm font-medium text-gray-500">Trabajo remoto</p>
                            <p class="text-xl md:text-2xl font-bold text-gray-900">{{ $statistics['remote_percentage'] }}%</p>
                ...
                <div class="bg-white rounded-lg shadow p-4 md:p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-orange-100 rounded-lg p-2 md:p-3">
                        ...
                        <div class="ml-3 md:ml-4">
                            <p class="text-xs md:text-sm font-medium text-gray-500">Sin cerrar</p>
                            <p class="text-xl md:text-2xl font-bold text-gray-900">{{ $statistics['pending_checkouts'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="overflow-x-auto -mx-4 md:mx-0">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap text-xs md:text-sm font-medium text-gray-900">{{ $week['label'] }}</td>
                                <td class="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap text-xs md:text-sm text-gray-900">{{ $week['hours'] }}h</td>
