        ...
        <div x-data="{ sidebarOpen: window.innerWidth >= 1024, sidebarCollapsed: false }"
            ...
            <div class="transition-all duration-200">
                <div class="flex-1 min-w-0">
                    <div x-bind:class="sidebarOpen && !sidebarCollapsed ? 'lg:ml-80' : sidebarOpen && sidebarCollapsed ? 'lg:ml-16' : ''" class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-4 transition-all duration-200">
                        @isset($header)
